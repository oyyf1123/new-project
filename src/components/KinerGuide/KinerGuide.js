...
class KinerGuide extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            offset: this.props.offset === undefined ? 0 : this.props.offset//有些时候，我们的指引框可能需要比目标区块稍微大一点，指定此偏移量，便可以调整指引框大小
        };
    }
    ...
    render() {
        ...
        if (target && this.state.visible) {
            ...
            return (<div className="guideModal-container" ref='guideContainer'
                         style={{width: document.documentElement.offsetWidth,height:'7.5rem'}}>
